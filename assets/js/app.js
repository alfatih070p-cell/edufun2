...
const StreakSystem = (() => {
  ...
  // Anti-duplikat: gunakan flag global per-session
  let _streakCheckDone = false;

  function checkAndShow() {
    // Cegah double-call dalam satu session (dari goDash + DOMContentLoaded)
    ...
    function _doCheck() {
      ...
      // Guard: jika lastShown sudah hari ini, langsung update UI saja
      ...
      // Tandai sudah check-in hari ini SEBELUM kasih XP
  ...
  // Reset flag saat user logout (FirebaseSync.stop() dipanggil sebelumnya)
